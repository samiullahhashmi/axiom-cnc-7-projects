...
function createCard(data, index) {
    ...
    card.innerHTML = `
        <div class="inner-card">
            ...
            <div class="circle">
                <h1 class="card-num">${currentActiveCard +1}/${cardElements.length}</h1>
            </div>
                <p class="data">Question: ${data.question}</p>
            </div>
            <div class="card-back">
                <div class="circle">
                <h1 class="card-num">${currentActiveCard +1}/${cardElements.length}</h1></div>
                    <p class="data">Answer: ${data.answer}</p>
                </div>
            </div>
        `;
